...
summary: 'Exportez les résultats des requêtes, les tableaux de bord, la page d"accueil et d"autres données vers des fichiers .CSV pour l"analyse externe, la création de rapports et l"intégration avec d"autres applications à l"aide du traitement asynchrone.' 
...
[role="lead"]
Exportez les données issues des requêtes, des widgets de tableaux de bord et des tableaux de pages d'accueil vers des fichiers .CSV pour l'analyse externe, la création de rapports et l'intégration avec d'autres applications. Le processus d'exportation asynchrone vous permet de poursuivre votre travail pendant le traitement en arrière-plan de grands ensembles de données.
