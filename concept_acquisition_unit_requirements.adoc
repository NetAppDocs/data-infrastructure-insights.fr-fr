...
| Système opérateur  a| 
Un ordinateur exécutant une version sous licence de l'un des éléments suivants :
...
Aucun autre logiciel applicatif ne doit être exécuté sur cet ordinateur. Un serveur dédié est recommandé.

Si vous utilisez SELinux, il est recommandé d'exécuter les commandes suivantes sur le système de l'unité d'acquisition :
...
50 Go (100 Go recommandés)

Sous Linux, l'espace disque doit être alloué de la manière suivante :

* /opt/netapp 10 Go (20 Go pour les grands environnements)
* /var/log/netapp 40 Go (80 Go pour les grands environnements)
* /tmp au moins 1 Go disponible lors de l'installation


Votre système de fichiers peut utiliser de l'espace pour son fonctionnement interne. Voici les espaces minimums qui doivent être  avant l'installation.
| 50 Go 
