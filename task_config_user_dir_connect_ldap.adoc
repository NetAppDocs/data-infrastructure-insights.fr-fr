...
+
** Installez link:http://ldaptool.sourceforge.net/["Explorateur LDAP"] ou link:http://jxplorer.org/["Explorateur LDAP Java"] sur n'importe quelle machine Windows pouvant se connecter au serveur LDAP.
