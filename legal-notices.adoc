...
link:media/DII_Notice-Sept_2025.pdf["Avis concernant Data Infrastructure Insights (anciennement Cloud Insights)"]

link:media/WS_Notice-Sept_2025.pdf["Avis relatif à la sécurité des charges de travail (anciennement Cloud Secure)"]
