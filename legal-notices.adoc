...
link:media/DII_ON-PREM_Notice_Nov2025.pdf["Avis concernant Data Infrastructure Insights (anciennement Cloud Insights)"]

link:media/DII_WS_Notice_Nov2025.pdf["Avis relatif à la sécurité des charges de travail (anciennement Cloud Secure)"]
