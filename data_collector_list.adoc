...
| link:task_dc_pure_flashblade.html["Pure FlashBlade"] | Infrastructure 
...
| lien:task_dc_redhat_openshift virtualization.html[Red Hat OpenShift Virtualization ] | Infrastructure 
