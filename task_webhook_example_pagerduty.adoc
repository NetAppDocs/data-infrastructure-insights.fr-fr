...
summary: 'Créez un webhook pour alerter sur les seuils de performance ou d"inventaire pour PagerDuty' 
---
...
. Saisissez un _nom_ et une _description_ pertinente. Cliquez sur _Suivant_.
+
image:webhook-pagerduty-1.png["PagerDuty écran, largeur=500"]

. Sur l'écran suivant, sélectionnez une politique d'escalade existante ou générez-en une nouvelle. Cliquez sur _Suivant_.
+
image:webhook-pagerduty-2.png["Attribution d'une politique d'escalade, width=500"]

. Sélectionnez les fonctionnalités AIOps souhaitées. Cliquez sur _Suivant_.
+
image:webhook-pagerduty-3.png["écran de sélection du service aiops, largeur=500"]

. Sélectionnez la ou les intégrations que vous souhaitez utiliser pour envoyer les alertes à PagerDuty. Pour DII, utilisez l’intégration Events API V2.
+
image:webhook-pagerduty-4.png["PagerDuty écran de sélection des intégrations, largeur=500"]



Sur l'écran de configuration de l'intégration, notez la *Clé d'intégration*. Vous aurez besoin de cette clé lorsque vous créerez le webhook Data Infrastructure Insights ci-dessous.

+ image:webhook-pagerduty-5.png["Copie de la clé d'intégration, width=500"]
