...
. Types de fichiers : supprimer les alertes de falsification de fichiers sur certains <<file-types,Types de fichiers autorisés>>
...
* Liste d'exclusion de répertoires : Prend en charge jusqu'à quatre niveaux de chemins de répertoires, en commençant par le chemin de jonction. Tous les sous-répertoires et fichiers sous ce chemin seront exclus de la génération d'alertes. Les caractères génériques dans les chemins de répertoires ne sont pas pris en charge.


image:ws_alert_exclusions_users.png["Utilisateurs exclus des alertes"]

image:ws_alert_exclusions_paths.png["Chemins d'exclusion des alertes"]
