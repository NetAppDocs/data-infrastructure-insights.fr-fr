...
summary: 'Accédez à des informations centralisées sur la gestion du stockage grâce à des rapports complets sur l"utilisation des capacités, les tendances de performance et les prévisions de ressources pour une gestion proactive des centres de données.' 
...
[role="lead"]
Le tableau de bord Storage Manager offre une vue d'ensemble centralisée de votre environnement de stockage grâce à des rapports et des visualisations complets. Surveillez l'utilisation de la capacité, suivez l'évolution des performances au fil du temps et comparez les indicateurs actuels aux plages acceptables afin de prendre des décisions éclairées concernant la maintenance de votre centre de données et la planification des ressources.
