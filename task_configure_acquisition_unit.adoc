...
Si vous constatez que votre AU est bloquée lors de la tentative de connexion à DII, essayez d'ajouter ces points de terminaison à votre proxy :
...
Les points de terminaison proxy spécifiques de la NetApp Console dont vous pourriez avoir besoin sont répertoriés dans la documentation link:https://docs.netapp.com/us-en/console-setup-admin/reference-networking-saas-console-previous.html#update-endpoint-list["Administrateur de configuration de la console"].
