...
summary: 'Configurez les collecteurs de données Workload Security pour Cloud Volumes ONTAP et Amazon FSx for NetApp ONTAP afin de surveiller l"accès aux fichiers, l"activité des utilisateurs et de détecter les menaces sur votre infrastructure de stockage cloud.' 
---
