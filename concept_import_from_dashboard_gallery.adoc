...
summary: Importez des tableaux de bord prédéfinis depuis la galerie pour obtenir rapidement des informations commerciales, ou importez des tableaux de bord personnalisés que vous avez exportés pour partager des configurations entre locataires. 
...
[role="lead"]
Accédez aux tableaux de bord prédéfinis de la galerie pour obtenir rapidement des informations sur votre infrastructure, ou importez des tableaux de bord personnalisés que vous avez exportés d'autres locataires. Les tableaux de bord de la galerie sont adaptés aux collecteurs de données de votre environnement et conçus pour répondre à des questions métier spécifiques, tandis que les tableaux de bord exportés vous permettent de partager des configurations utiles entre plusieurs locataires.
