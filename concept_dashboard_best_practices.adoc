...
summary: Découvrez les meilleures pratiques pour trouver les indicateurs pertinents, filtrer efficacement les ressources et configurer les widgets afin de créer des tableaux de bord performants et instructifs. 
...
[role="lead"]
Maîtrisez la création de tableaux de bord grâce à des stratégies éprouvées pour identifier les bons indicateurs, filtrer efficacement les ressources et configurer les widgets afin d'obtenir une vision optimale. Ces bonnes pratiques vous aident à concevoir des tableaux de bord plus performants qui fournissent des informations exploitables sur l'infrastructure.
