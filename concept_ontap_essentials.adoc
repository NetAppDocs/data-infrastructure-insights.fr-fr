...
Le tableau de bord de sécurité vous offre une vue instantanée de votre situation de sécurité actuelle, affichant des graphiques pour le chiffrement du volume matériel et logiciel, l'état de la protection contre la falsification des fichiers et les méthodes d'authentification du cluster. Les critères de sécurité sont évalués sur la base des recommandations définies dans le link:https://www.netapp.com/pdf.html?item=/media/10674-tr4569.pdf["* Guide de renforcement de la sécurité NetApp pour ONTAP 9*"].

Sélectionnez l'un des comptes de chiffrement ou de protection contre la falsification de fichiers pour explorer votre environnement.
