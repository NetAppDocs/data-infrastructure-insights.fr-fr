...
| Adresse IP de l'hôte StorageGRID | Adresse IP de gestion du StorageGRID (Grid Manager) 


| Nom d'utilisateur | Nom utilisé pour se connecter à StorageGRID (Grid Manager) 


| Mot de passe | Mot de passe utilisé pour se connecter à StorageGRID (Grid Manager) 
|===
