...
NOTE: La collecte des performances de Data Infrastructure Insights à partir des clusters VPLEX nécessite que le service d’archivage des performances soit opérationnel, afin d’alimenter les fichiers .CSV et les journaux que Data Infrastructure Insights récupère via des copies de fichiers basées sur SCP. NetApp a constaté que de nombreuses mises à niveau du firmware ou des stations de gestion VPLEX laissent cette fonctionnalité non opérationnelle. Les clients prévoyant de telles mises à niveau peuvent vouloir demander de manière proactive à Dell/EMC si leur mise à niveau prévue rendra cette fonctionnalité inopérante et, si c’est le cas, comment la réactiver afin de minimiser les lacunes dans la visibilité des performances. Le code de performance VPLEX de Cloud Insights évaluera à chaque interrogation si tous les fichiers attendus existent et s’ils sont correctement mis à jour ; s’ils sont manquants ou obsolètes, Data Infrastructure Insights consignera les échecs de collecte des performances.
