...
summary: 'Améliorez la détection des attaques en intégrant Workload Security à ONTAP Autonomous Protection pour une analyse corrélée, des réponses automatisées et des capacités d"enquête médico-légale.' 
