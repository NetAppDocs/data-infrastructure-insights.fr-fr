...
summary: 'Lors de l"interrogation pour une densité d"E/S élevée, vous devez exclure les volumes racine.' 
...
[[create-an-annotation-rule-to-automate-excluding-specific-aggregates-from-your-io-density-report]]
