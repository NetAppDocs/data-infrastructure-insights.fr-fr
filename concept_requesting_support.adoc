...
[role="lead"]
Data Infrastructure Insights propose des options d'assistance complètes, notamment des ressources en libre-service, des forums communautaires, de la documentation et un support technique. Accédez à ces ressources d'assistance en sélectionnant *Aide > Support*, et envisagez d'activer votre droit à l'assistance pour bénéficier d'une assistance technique complète via des tickets web et une assistance téléphonique.
...
Il est fortement recommandé de cocher la case permettant à un NetApp Support Engineer d'accéder à votre site Data Infrastructure Insights pendant votre session d'assistance. Cela permettra à l'ingénieur de diagnostiquer le problème et de vous aider à le résoudre rapidement. Pendant que le Support Engineer a accès à votre site, il pourra effectuer toutes les fonctions de niveau administrateur.

Lorsque votre problème est résolu ou que votre session d'assistance est terminée, vous pouvez décocher la case.

Vous pouvez demander de l'aide en vous rendant sur le link:https://www.netapp.com/support-and-training/["Site de support NetApp"]. Vous devez disposer d'un abonnement actif à Data Infrastructure Insights.
