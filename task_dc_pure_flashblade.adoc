...
summary: Configuration du collecteur de données Pure FlashBlade Storage 
---
...
[role="lead"]
Data Infrastructure Insights utilise le collecteur de données Pure Storage FlashBlade pour recueillir des données d'inventaire et de performance à partir de clusters FlashBlade exposant la version 2 de leur API REST.
