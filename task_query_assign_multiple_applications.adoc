...
summary: Gérez efficacement les applications et les annotations sur plusieurs ressources grâce à des opérations groupées basées sur des requêtes pour les attribuer ou les supprimer sans configuration manuelle et individuelle de chaque ressource. 
...
[role="lead"]
Optimisez la gestion des ressources en utilisant des requêtes pour effectuer des opérations groupées sur les applications et les annotations. Au lieu de configurer manuellement chaque ressource individuellement, vous pouvez attribuer ou supprimer efficacement plusieurs applications et annotations sur des groupes de ressources en une seule opération.
