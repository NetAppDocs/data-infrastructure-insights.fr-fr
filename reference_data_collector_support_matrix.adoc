...
* 4.3.1
* 4.3.3
* 4.4.1 Type de version : Support standard
* 4.5.15 Type de version : Extended Support Release
* 4.5.18 Type de version : Version à support étendu
* 4.5.21 Type de version : Extended Support Release
* 4.5.24 Type de version : Extended Support Release
* 4.5.7 Type de version : Extended Support Release
* 4.6.1 Type de version : Extended Support Release
* 9.5.15 Type de version : Version à support étendu
* 9.5.8 Type de version : Extended Support Release
* 9.6.1 Type de version : Version à support étendu
...
* Brocade 6558
* Brocade 7800
* Commutateur d'extension Brocade 7810
* Brocade 7840
* Brocade DCX
...
.86+| fondation .9+| Disque | Capacité (Go) | Mis en œuvre | HTTPS |  
...
.13+| Piscine de stockage | Inclure dans la capacité de l'eau chaude sanitaire | Mis en œuvre | HTTPS |  
...
.18+| Volume | Identifiant de politique AutoTier | Mis en œuvre | HTTPS |  
...
.4+| fondation .4+| Informations | Nom de la source de données | Mis en œuvre | HTTP/S | Informations 
...
.15+| performance .4+| Données du nœud de stockage | Taux de réussite du cache total | Mis en œuvre | SSH |  
...
.110+| fondation .15+| Disque | Capacité (Go) | Mis en œuvre |  |  
...
.7+| Nœud de stockage | Taille du cache | Mis en œuvre | HTTPS |  
