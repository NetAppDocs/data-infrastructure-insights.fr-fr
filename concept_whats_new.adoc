...
Page de détails pour une potentielle attaque de ransomware : -Vue « Écran » : Les widgets de tableau affichent l’objet/le groupement sur le côté gauche et les données de l’objet (attributs/métriques) sur le côté droit.
...
'''
Widget valeur avec mise en forme] image:Single-Value Widgets - Formatted.png["Widgets à valeur unique avec formatage"]
