...
=== L'assistant IA de DII est disponible pour tous!

L'assistant IA Data Infrastructure Insights est disponible en avant-première et inclut désormais les améliorations suivantes :

* Disponibilité de la région Azure : Pour les clients dont le site DII est hébergé sur Azure, le DII Assistant est désormais prêt à vous aider.
* Jusqu'à 7 jours de données : L'Assistant peut désormais accéder à jusqu'à 7 jours de métriques haute résolution, permettant une analyse de données et des insights plus larges.
