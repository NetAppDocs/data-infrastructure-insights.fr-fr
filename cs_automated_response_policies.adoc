...
summary: 'Configurez des politiques de réponse automatisées pour prendre des mesures immédiates lors d"incidents de sécurité, notamment la prise de clichés instantanés, la restriction d"accès des utilisateurs et les notifications par webhook en cas de menaces et de comportements suspects.' 
---
...
image:ws_add_attack_policy.png["Ajouter une boîte de dialogue de stratégie d'attaque affichant une liste déroulante de webhook, largeur=300"]
