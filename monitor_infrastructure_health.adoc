...
summary: 'Obtenez une vue unifiée de l"état de santé de votre environnement de stockage grâce à une surveillance complète qui combine les alertes de performance, de capacité, de configuration et de composants en scores de santé exploitables.' 
---
...
[role="lead"]
Data Infrastructure Insights surveille l'état de santé de votre environnement de stockage en suivant les performances, la capacité, la configuration et l'état des composants. Le système calcule des scores d'état de santé unifiés à partir des alertes de surveillance couvrant ces catégories, offrant une visibilité claire sur l'état du système et permettant une résolution proactive des problèmes.
