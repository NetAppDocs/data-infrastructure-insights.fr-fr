...
NOTE: Étant donné que la console NetApp dispose de son propre délai d’expiration de connexion utilisateur de 7 jours, Data Infrastructure Insights doit également se déconnecter avec cet événement.  Vous pouvez simplement vous reconnecter et votre tableau de bord continuera à s'afficher.
