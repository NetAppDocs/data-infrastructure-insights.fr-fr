...
summary: 'Questions fréquemment posées sur la configuration de Data Infrastructure Insights, la prise en charge des appareils, l"impact environnemental, les autorisations et les capacités de collecte de données.' 
---
...
[[what-is-data-infrastructure-insightss-impact-to-my-environment]]
...
[[how-can-i-list-all-the-hostsvms-in-data-infrastructure-insights]]
